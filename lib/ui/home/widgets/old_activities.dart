...
class OldActivities extends StatelessWidget {
  final OldActivitiesViewModel _viewModel;

  const OldActivities({super.key, required OldActivitiesViewModel viewModel})
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider.value(
      value: _viewModel,
      child: Consumer<OldActivitiesViewModel>(
