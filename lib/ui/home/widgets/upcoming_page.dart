...
class UpcomingPage extends StatelessWidget {
  ...
  const UpcomingPage({super.key, required this.state});
  ...
  Map<DateTime, List<Activity>> _groupActivitiesByDate(List<Activity> activities) {
    ...
    for (var activity in activities) {
      if (activity.startTime == null || activity.startTime!.isBefore(now)) continue;
  ...
  Widget build(BuildContext context) {
    ...
    if (state is HomePageErrorState) {
      return const Center(child: Text('Error loading upcoming activities'));
    }
    ...
    if (state is HomePageSuccessState) {
      ...
      final sortedDates = groupedActivities.keys.toList()
        ..sort((a, b) => a.compareTo(b)); // Sort dates in ascending order for upcoming
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: Text(
                                          activity.collaborators.isEmpty
                                              ? "You"
